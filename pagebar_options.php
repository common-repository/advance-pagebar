...
if (!class_exists('PagebarOptions')) {
	...
	?>
	<p class="submit"><input type="submit" name="Advance Pagebarupdate" class="button-primary"
...
<h2 style="text-align: left">For More Useful Plugins Visit:<a href="http://111waystomakemoney.com/" target="_blank">Wordpress Plugins</a></h2>
...
<h2 style="text-align: left">If u like the plugin please Donate:<a href="http://111waystomakemoney.com/donate/" target="_blank">Plugin Donation Page</a></h2>
	...
	function adminmenu() {
		...
		add_contextual_help(
			$hook,
			'<a href="http://111waystomakemoney.com/advance-pagebar//" target="_blank">Manual</a>'
		); }
...
<h1 style="text-align: left">For Instructions Visit:<a href="http://111waystomakemoney.com/advance-pagebar/" target="_blank">Plugin Page</a></h1>
